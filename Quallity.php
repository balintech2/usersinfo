...
<head>
  ...
  <title>Computer's information of the Quallity unit</title>
  <meta charset="UTF-8">
...
<body class="bodyMan">
  ...
  <div class="boxtable">
    <div class="divheaderTable">
      <h2>Computer's information of the Quallity unit</h2>
    ...
    <table>
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (isset($_POST['inputSearch']) && $_POST['inputSearch'] != "") {
          ...
          $sql_q = "SELECT * FROM `accessories` where department='Quallity' &&  user_fullname like '$inputSeach%' && reg_username='$user_acount'";
          ...
          if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
              ...
              echo "<th>$monitor</th>\n";
              echo "<th>\n";
              echo "<a href='edit.php?id=$person_id&method=edit&ref=Quallity'><img class='editDeleteRow' src='img/edit4.png' alt='Edit'></a>\n";
              echo "<a href='Quallity.php?id=$person_id&method=delete'><img class='editDeleteRow' src='img/delete.jpg' alt='Edit'></a>\n";
              echo "</th>\n";
              echo "</tr>\n";
  ...
  VALUES (
      ...
      if (!isset($_POST['inputSearch']) || $_POST['inputSearch'] == "") {
        $sql_q = "SELECT * FROM `accessories` where department='Quallity' && reg_username='$user_acount'";
        $result = $conn->query($sql_q);
