        ...
        if (isset($_POST['inputSearch']) && $_POST['inputSearch'] != "") {
          ...
          if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
              ...
              echo "<a href='InformaticsPersonal.php?id=$person_id&method=delete'><img class='editDeleteRow' src='img/delete.jpg' alt='Edit'></a>\n";
              echo "</th>\n";
              echo "</tr>\n";
      ...
      if (!isset($_POST['inputSearch']) || $_POST['inputSearch'] == "") {
        ...
        if ($result->num_rows > 0) {
          ...
          while ($row = $result->fetch_assoc()) {
            ...
            echo "<th>$monitor</th>\n";
            echo "<th>\n";
            echo "<a href='edit.php?id=$person_id&method=edit&ref=InformaticsPersonal'><img class='editDeleteRow' src='img/edit4.png' alt='Edit'></a>\n";
            echo "<a href='InformaticsPersonal.php?id=$person_id&method=delete'><img class='editDeleteRow' src='img/delete.jpg' alt='Edit'></a>\n";
            echo "</th>\n";
            echo "</tr>\n";
